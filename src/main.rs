    ...
    unsafe {
        ...
        match ip {
            IpAddr::V4(v4) => {
                ...
                // BSD-derived systems (macOS, FreeBSD, etc.) have sin_len field and u8 sin_family
                #[cfg(any(
                    target_os = "macos",
                    target_os = "freebsd",
                    target_os = "openbsd",
                ...
                // Linux and other POSIX systems use u16 sin_family and no sin_len
                #[cfg(not(any(
                    target_os = "macos",
                    target_os = "freebsd",
                    target_os = "openbsd",
            ...
            IpAddr::V6(v6) => {
                // BSD-derived systems have sin6_len field and u8 sin6_family
                #[cfg(any(
                    target_os = "macos",
                    target_os = "freebsd",
                    target_os = "openbsd",
